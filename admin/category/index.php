            ...
            <div class="profile-admin__table col-9">
                ...
                <?php foreach($categories as $key => $category):?>
                  <div class="profile-admin__table-data row">
                      <div class="profile-admin__table-row col-1"><?=$category['id_category']?></div>
                      <div class="profile-admin__table-row col-5"><?=$category['name']?></div>
                      <div class="profile-admin__table-row profile-admin__table-data_edit col-1"><a href="edit.php?id=<?=$category['id_category']?>">Edit</a></div>
                      <div class="profile-admin__table-row profile-admin__table-data_del col-1"><a href="edit.php?del_id=<?=$category['id_category']?>">Delete</a></div>
                  </div>
                <?php endforeach; ?>
            </div>
        </div>
