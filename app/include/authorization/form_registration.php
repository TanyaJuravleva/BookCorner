        ...
        <div class="modal__wrapper">
            <div aria-labelledby="modal-1-title" role="dialog" aria-modal="true" class="modal__container form-popup">
                <div class="form-block">
                    ...
                    <form enctype="multipart/form-data" action="app/controller/reg.php" method="POST" name="login" class="form-block__login" novalidate="novalidate">
                        <input type="hidden" name="form_type" value="login">
                        <input class="form-block__item js-form-input" type="text" name="name" placeholder="Ваше имя">
                        <input class="form-block__item js-form-input" type="text" name="phone" placeholder="Телефон">
                        <input class="form-block__item js-form-input" type="text" name="email" placeholder="Email">
